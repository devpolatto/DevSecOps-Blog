...
|if|for / select|
|---|---|
|if COMANDO<br>then<br>   ...<br>elif COMANDO<br>then<br>   ...<br>else<br>   ...<br>fi|for VAR in LISTA<br>do<br>    ...<br>done<br><br>ou:<br><br>for ((exp1;exp2;exp3))|
|while / until|case|
|while COMANDO<br>do<br>    ...<br>done|case $VAR in<br>    txt1) ... ;;<br>    txt2) ... ;;<br>    txtN) ... ;;<br>    *)    ... ;;<br>esac|
...
![](https://aurelio.net/shell/canivete/zzcores.gif)
...
$ [zzascii](https://funcoeszz.net/todas.html)
...
![](https://aurelio.net/shell/canivete/ascii.gif)
